...
class Fault_feature():
    ...
    def encoding(extents, mesh_list, surface_points, orientation_points, movement=[], decimate=0.0, fault_direct=[]):
        """
        ...
        for mesh in mesh_list:
            ...
            # do not encoding the grid mesh here
        ...
        return label_interf_all, orie_points_all
